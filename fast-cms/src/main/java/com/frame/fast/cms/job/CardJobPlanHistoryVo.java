...
public class CardJobPlanHistoryVo extends CardJobPlanHistory {
    ...
    public static List<CardJobPlanHistoryVo> tranFromOrigin(List<CardJobPlanHistory> cardJobPlanHistories){
        List<CardJobPlanHistoryVo> dailyJobVos = new ArrayList<>();
        if(CollectionUtils.isNotEmpty(cardJobPlanHistories)){
            cardJobPlanHistories.forEach(n->{
                CardJobPlanHistoryVo vo = new CardJobPlanHistoryVo();
