...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'orderId', title: '订单号', sortable: true, halign: 'center'},
			{field: 'prepayId', title: '微信订单号', sortable: true, halign: 'center'},
			{field: 'productSortDesc', title: '产品类型', sortable: true, halign: 'center'},
			{field: 'orderStatusDesc', title: '订单状态', sortable: true, halign: 'center'},
			{field: 'totalFee', title: '总价', sortable: true, halign: 'center',formatter:'actionFee'},
			{field: 'couponFee', title: '优惠金额', sortable: true, halign: 'center',formatter:'actionFee'},
			{field: 'realFee', title: '实付', sortable: true, halign: 'center',formatter:'actionFee'},
			{field: 'createAt', title: '创建日期', sortable: true, halign: 'center',formatter: 'actionFormatter'},
...
function actionFormatter(value, row, index) {
    return value.date.year + '年' + value.date.month + '月' + value.date.day + '日';
}
