...
<header id="header">
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			...
			<span id="system_title">乐速管理系统</span>
		</li>
		<li class="pull-right">
			<ul class="hi-menu">
				<!-- 搜索 -->
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dm-icon pull-right">
						...
						<li>
							<a class="waves-effect" onclick="window.location.href='/logout'"><i class="zmdi zmdi-run"></i> 退出登录</a>
						</li>
					</ul>
				</li>
			</ul>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			...
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts-list"></i> 用户</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('用户信息', '/user/toList');">用户信息</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('用户月卡', '/user/toMonthInfoList');">用户月卡</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('用户单次', '/user/toSingleInfoList');">用户单次</a></li>
			</ul>
			</li>
			<li class="sub-menu system_menus system_1 3">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i> 订单</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('订单信息', '/order/toList');">订单信息</a></li>
			</ul>
			</li>
			<li class="sub-menu system_menus system_1 6">

			<li class="sub-menu system_menus system_1 3">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i> 回收服务</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('日常回收管理', '/job/daily/toList');">日常回收管理</a></li>
			</ul>
			<ul>
			...
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('职员管理', '/staff/toList');">职员管理</a></li>
			</ul>
			</li>
			<li class="sub-menu system_menus system_1 6">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i> 活动</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('轮播图', '/manage/role/index');">轮播图</a></li>
			</ul>
			</li>
			<li class="sub-menu system_menus system_1 7">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i> 优惠券</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('优惠券管理', 'coupon/toList');">优惠券管理</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('优惠券使用', '/coupon/batch/toList');">优惠券使用</a></li>
			</ul>
			</li>

			<li class="sub-menu system_menus system_1 7">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i> 渠道</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('渠道管理', '/channel/toList');">渠道管理</a></li>
			</ul>
			</li>
			<li class="sub-menu system_menus system_1 7">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i> 日志</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('异常日志', '/manage/role/index');">异常日志</a></li>
			</ul>
			</li>
			<#--<li class="sub-menu system_menus system_1 6">
