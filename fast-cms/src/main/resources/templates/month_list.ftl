...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'statusDesc', title: '月卡状态', sortable: true, halign: 'center'},
			{field: 'remainNum', title: '剩余次/天数', sortable: true, halign: 'center'},
			{field: 'endEffectDate', title: '失效日期', sortable: true, halign: 'center',formatter: 'actionFormatter'},
